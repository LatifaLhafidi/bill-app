...
describe("Given I am connected as an employee", () => {
  ...
  /* ajouter un test qui teste l'ouverture de modal quand'on click sur l'oeil */ 
  test("Then modal should be displayed with correct content when eye icon is clicked",
    async () => {
